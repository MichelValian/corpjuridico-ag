...
export default function LawyerDeleteModal({ isOpen, onClose, onConfirm, abogado, loading }) {
  return (
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ¿Estás seguro de que deseas eliminar al abogado <span className="font-bold">{abogado?.name} {abogado?.lastName}</span>? Esta acción no se puede deshacer.
                  </p>
                </div>
