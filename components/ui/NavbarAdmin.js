...
export default function Header() {
  ...
  const handleNavigation = (href) => {
    if (window.location.pathname !== "/") {
      window.location.href = "/" + href; // Redirigir a la página principal con el hash
    } else {
      window.location.hash = href; // Si ya estás en la principal, solo cambia el hash
    }
  };
...
>
        ...
        <div className="hidden lg:flex lg:items-center lg:justify-center">  {/* Cambié justify-end a justify-center */}
          <a href="/login" className="text-sm font-semibold text-blue-900">
        ...
        {/* <img src="/img/logo.png" alt="Logo" className="w-8 h-8" /> */}
         ...
         {/* Close button */}
          ...
          <div className="py-6">
            <a
              href="/login"
              className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-blue-900 hover:bg-gray-50 cursor-pointer"
