...
export default function UserEditModal({ isOpen, onClose, onSave, user }) {
  ...
  const validateForm = () => {
    ...
    // Validar contraseña si es ingresada
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      onSave({ ...userData, id: user.id });  // Enviar los datos al parent
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-100">
        <h2 className="text-xl text-blue-900 font-semibold mb-4">Editar Usuario</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-4 gap-4">
            ...
            {/* Contraseña */}
            <div className="col-span-2">
              <label className="text-gray-500 text-sm font-semibold mb-1">Nueva contraseña</label>
