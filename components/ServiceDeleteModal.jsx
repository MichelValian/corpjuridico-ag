...
export default function ServiceDeleteModal({ isOpen, onClose, onConfirm, servicio, loading }) {
  return (
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ¿Estás seguro de que deseas eliminar el servicio <span className="font-bold">{servicio?.name}</span>? Esta acción no se puede deshacer.
                  </p>
                </div>
